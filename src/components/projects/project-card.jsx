                    ...
                    <div className="lg:-mx-6 lg:flex lg:items-center">
                        ...
                        <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
                            ...
                            <div className="flex items-center mt-6">
                                {/* <button type="button" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-md sm:text-sm px-1.5 py-2 sm:px-5 sm:py-2.5 text-center inline-flex w-fit items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
                                    <a href="/" rel="noreferrer" target="_blank" className="flex">Case Study
                                ...
                                {/* <button type="button" className="inline-block rounded-full p-3 text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:outline-none focus:ring">
                                    <a href="https://github.com/kwing25/Women-Who-ve-Changed-Tech" rel="noreferrer" target="_blank" className="flex">
