...
function BlogPostPreview(props) {
    return (
        ...
        <Link to={`/blog/${props.slug.current}`} className="flex justify-center items-center relative h-96 min-h-80 ">
            ...
            <div className="relative p-8 bg-black/30 transition duration-0 hover:duration-150 hover:bg-black rounded-xl">
                        ...
                        {props.categories && props.categories.length > 0 && (
                            <div className="inline-flex">
                                {props.categories.map(category => (
                                    <div key={category._id} className="flex px-2 mx-2 mt-2 rounded-lg  bg-[#ff006e]/50 hover:bg-[#ff006e]/80">
